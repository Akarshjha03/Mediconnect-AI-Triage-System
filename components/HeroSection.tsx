...
import { APP_NAME } from '../constants.ts'; // Import APP_NAME for consistency
  ...
  return (
    <div className="relative bg-gradient-to-br from-primary via-teal-700 to-teal-900 text-white py-24 md:py-40 overflow-hidden">
      ...
      <div className="absolute inset-0 z-[5]" aria-hidden="true">
        ...
        <div className="absolute top-1/4 left-4 sm:left-10 md:left-20 transform -translate-y-1/2">
          <div className="relative w-32 h-32 sm:w-40 sm:h-40 md:w-48 md:h-48">
            <div className="absolute top-0 left-0 w-full h-full rounded-full bg-white opacity-05"></div>
            <div className="absolute top-1/4 left-1/4 w-3/4 h-3/4 rounded-full bg-white opacity-10"></div>
            <div className="absolute bottom-0 right-0 w-1/2 h-1/2 rounded-full bg-white opacity-05"></div>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="md:pr-8">
            ...
            <button 
              ...
              className="bg-accent text-white font-semibold py-4 px-10 rounded-lg shadow-lg hover:bg-pink-500 transition-transform transform hover:scale-105 text-lg flex items-center"
            >
          ...
          <div className="bg-white/80 backdrop-blur-xl p-8 md:p-10 rounded-xl shadow-2xl border border-primary/30"> {/* Enhanced form container */}
            <h2 className="text-3xl font-bold text-dark mb-8 text-center">Quick Inquiry</h2>
