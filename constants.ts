...
export const NAV_LINKS: PageLink[] = [
  ...
  { name: 'Login', path: '/login' }, // Consolidated Login link
];
...
export const RAZORPAY_KEY_ID: string = 'rzp_test_1DP5mmOlF5G5ag'; // Standard Razorpay Public Test Key
export const APPOINTMENT_FEE = 1000; // in paisa (e.g., 10 INR)
export const WHATSAPP_SUPPORT_NUMBER = '+12345678900'; // Replace with your actual WhatsApp support number e.g., +91XXXXXXXXXX
