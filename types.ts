...
// Types for the old rule-based chatbot. Kept for compatibility, but no longer used in the new AI implementation.
export interface MinorDiseaseInfo {
  keywords: string[];
  response: string;
}

export interface MajorDiseaseInfo extends MinorDiseaseInfo {
